...
//             <div className="flex items-center bg-gray-900 rounded px-5 py-2">
//               <label className="mr-4 text-white">Clear All Tasks</label>
//               <button className="bi bi-x-lg text-red-500 text-xl"></button>
//             </div>
//             <button
